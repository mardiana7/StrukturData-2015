...
public class ChatToUpper { 
    String balasan = "";
    public void whois(String namaDomain) throws UnknownHostException, IOException {
        //Buka socket
        koneksi = new Socket("192.168.43.139", 33333);
        // Kirim perintah untuk informasi namaDomain
        kirimPerintah(namaDomain);
        bacaBalasan();
        kirimPerintah(balasan);
    ...
    public void kirimPerintah(String namaDomain) throws IOException {
      ...
      public void bacaBalasan() throws IOException {
        ...
        while (data != -1) {
            balasan = balasan + Character.toUpperCase(data);
